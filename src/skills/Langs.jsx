          ...
          <div className='flex flex-row justify-center'>
            <ul className='flex flex-wrap justify-center gap-10'>
              {skill.lans.map((language, idx) => (
                <li key={idx}>
                  <div className='flex flex-row border-2 px-4 py-2 border-slate-300 justify-start rounded-md w-full gap-3 hover:transition-all hover:ease-in-out duration-200 cursor-default'>
                    {/* image of lang */}
                    <div>
