            ...
            <div className="p-4 text-center">
              ...
              {achievement.link && (
                <a
                  ...
                  className="inline-block bg-green-600 text-white font-semibold px-4 py-2 mt-2 rounded-lg hover:bg-green-700 hover:rounded-full transition-all duration-150"
                  target="_blank"
